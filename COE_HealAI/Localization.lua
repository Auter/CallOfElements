...
COE_OptionEnableDistanceCheck = "Replace any totems farther than\n20y away when placing a set\nRequires SuperWoW";
...
BINDING_HEADER_COE_HEALAI = "COE HealAI";
BINDING_NAME_COESHOWCONFIG = "Show configuration dialog";

-- Primary HealAI keybinds
BINDING_NAME_COEHEALBRAIN = "HealAI (Smart One-Button)";
BINDING_NAME_COEDISPEL = "HealAI Dispel Only";

-- Legacy keybinds (kept for compatibility)
BINDING_NAME_COEBESTHEAL = "[Legacy] Threshold Heal";
BINDING_NAME_COEBATTLEHEAL = "[Legacy] Fast Heal";
